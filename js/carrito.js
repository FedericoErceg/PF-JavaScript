...
ProductosDelCarrito.forEach((e) => {
  const productoDiv = document.createElement("div");
    productoDiv.classList.add("row", "m-4")
  productoDiv.innerHTML = `
    ...
    <div class="ms-3">
        <button id="btn-carrito" class="btn btn-sumar" type="button">
        ...
        <button id="btn-carrito" class="btn btn-carrito btn-restar" type="button">
